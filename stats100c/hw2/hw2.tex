...
\begin{problem}{}{2}{0}
  ...
  \begin{align}
    ...
    Var(\betah_c) &=\sigma^2 (X^{'}X)^{-1} - 
                    \sigma^2 (X^{'}X)^{-1}c^{'}[c^{'}(X^{'}X)^{-1}c]^{-1}c(X^{'}X)^{-1}
  \end{align}
\end{problem}
...
\begin{problem}{}{6}{0}
  ...
  \begin{align}
    ...
    \pmate
  \end{align}
  Therefore $Cov(\betah_1, \betah_2) = 0$
  \section{b}
  \begin{align}
    X = 
    \pmatb
...
\begin{problem}{}{7}{0}
  ...
  \textbf{$E[y_{n+1}]$:} 
  \begin{align}
    E[y_{n+1}] &= E[x_{n+1}^{'}\beta + \varepsilon_{n+1}] = x_{n+1}^{'}\beta 
  \end{align}
  \section{b}
  \begin{align}
    ...
    (a^{'}X - x_{n+1}^{'})\beta &= 0 \implies a^{'}X = x_{n+1}^{'}
  \end{align}
  \section{c}
  \begin{align}
    ...
    Var(\hat{y}_{n+1}) &= \sigma^2 x_{n+1}^{'}(X^{'}X)^{-1}x_{n+1}
  \end{align}
  \begin{align}
    Var(\tilde{y}_{n+1}) &= Var(a^{'}Y) = \sigma^2 a^{'}a  
  \end{align}
  \section{d}
  \begin{align}
    Var(\tilde{y}_{n+1}) - Var(\hat{y}_{n+1}) &= 0 \\
    \sigma^2 a^{'}a - \sigma^2 x_{n+1}^{'}(X^{'}X)^{-1}x_{n+1} &= 0\\
    \sigma^2 a^{'}a - \sigma^2 a^{'}x(X^{'}X)^{-1}x^{'}a  &= 0 \\ 
    \sigma^2 a^{'} (I - X(X^{'}X)^{-1}X^{'})a &= 0 \\
    \sigma^2 a^{'}(I-H)a &= 0
  \end{align}
\end{problem}
%-------------------------------------------------------------------------------
